...
public class NursingProjectController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(@ApiParam("导出护理项目") HttpServletResponse response, NursingProject nursingProject)
    {
        List<NursingProject> list = nursingProjectService.selectNursingProjectList(nursingProject);
    ...
    @GetMapping(value = "/{id}")
    public R<NursingProject> getInfo(@PathVariable("id") @ApiParam("获取护理项目信息") Long id)
    {
    ...
    @PostMapping
    public AjaxResult add(@RequestBody @ApiParam("新增护理项目") NursingProject nursingProject)
    {
        return success(nursingProjectService.insertNursingProject(nursingProject));
    }
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody @ApiParam("修改护理项目") NursingProject nursingProject)
    {
	...
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@PathVariable @ApiParam("删除护理项目") Long[] ids)
    {
