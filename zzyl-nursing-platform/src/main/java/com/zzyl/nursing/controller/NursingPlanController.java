...
public class NursingPlanController extends BaseController
{
    ...
    @PostMapping("/export")
    public void export(@ApiParam("导出的条件查询") HttpServletResponse response, NursingPlan nursingPlan)
    {
        List<NursingPlan> list = nursingPlanService.selectNursingPlanList(nursingPlan);
    ...
    @PostMapping
    public AjaxResult add(@ApiParam("新增的护理计划对象") @RequestBody NursingPlan nursingPlan)
    {
    ...
    @PutMapping
    public AjaxResult edit(@ApiParam("修改护理计划对象") @RequestBody NursingPlan nursingPlan)
    {
	...
	@DeleteMapping("/{ids}")
    public AjaxResult remove(@ApiParam("删除护理计划ID") @PathVariable Long[] ids)
    {
