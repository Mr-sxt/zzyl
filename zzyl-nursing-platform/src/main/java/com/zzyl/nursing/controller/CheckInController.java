...
public class CheckInController extends BaseController
{
    ...
    @ApiOperation("申请入住")
    @PostMapping("/apply")
    public AjaxResult apply(@RequestBody @ApiParam("入住对象") CheckInApplyDto checkIn) {
        checkInService.apply(checkIn);
    ...
    public R<CheckInDetailVo> detail(@PathVariable @ApiParam("入住ID") Long id) {
       return R.ok(checkInService.detail(id));
    }
}
